...
insert into products (
  ...
  4500000, NULL,
  'Raw Silk', '3-Piece Suits', 'Women', 'Emerald',
  NULL, 25,
  true,
  false,
  NULL,
...
insert into products (
  ...
  6250000, NULL,
  'Velvet', '3-Piece Suits', 'Women', 'Midnight Blue',
  NULL, 25,
  true,
  false,
  NULL,
...
insert into products (
  ...
  3800000, NULL,
  'Organza', '3-Piece Suits', 'Women', 'Blush',
  NULL, 25,
  true,
  false,
  NULL,
...
insert into products (
  ...
  1290000, NULL,
  'Karandi', 'Formal Suiting', 'Men', 'Ivory',
  NULL, 25,
  true,
  false,
  NULL,
...
insert into products (
  ...
  1450000, NULL,
  'Egyptian Cotton', 'Kurta Fabric', 'Men', 'Signature White',
  NULL, 25,
  false,
  false,
  NULL,
  'Sold by FUJRS', NULL, NULL, NULL, '4.5 Meters',
  4.8, 54
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  890000, NULL,
  'Latha', 'Kurta Fabric', 'Men', 'Deep Navy',
  NULL, 25,
  false,
  false,
  NULL,
...
insert into products (
  ...
  1220000, NULL,
  'Karandi', 'Kurta Fabric', 'Men', 'Slate Gray',
  NULL, 25,
  false,
  false,
  NULL,
  NULL, NULL, NULL, NULL, '4.0 Meters',
  4.6, 31
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  750000, NULL,
  'Wash & Wear', 'Formal Suiting', 'Men', 'Off-White',
  NULL, 25,
  false,
  false,
  NULL,
  NULL, NULL, NULL, NULL, '4.5 Meters',
  4.4, 17
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  1080000, NULL,
  'Cotton', 'Kurta Fabric', 'Men', 'Forest Green',
  NULL, 25,
  false,
  false,
  NULL,
...
insert into products (
  ...
  4850000, NULL,
  'Pure Raw Silk (80gm)', '3-Piece Suits', 'Women', 'Gold',
  'FJ-UNS-AG882', 25,
  false,
  true,
  1250000,
  'Sold by FUJRS', 'The ''Aurelian'' weave draws inspiration from the royal courts of the 17th-century Mughal era. Hand-woven on traditional looms in Banaras, this raw silk base undergoes a unique gold-dipping process before being meticulously embroidered by fourth-generation artisans. Every stitch tells a story of perseverance and refined luxury.', 'Gold Tilla, Zardozi, Sequins', '2.5 Meters Organza with Border', '4.5 Meters (Standard Suit)',
  4.9, 124
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  1490000, NULL,
  'Lawn', '2-Piece Suits', 'Women', 'Black',
  NULL, 25,
  false,
  false,
  NULL,
  'Best Seller', NULL, NULL, NULL, NULL,
  4.7, 61
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  1820000, NULL,
  'Chiffon', '2-Piece Suits', 'Women', 'Pastel Blue',
  NULL, 25,
  false,
  false,
  NULL,
  'Official Store', NULL, NULL, NULL, NULL,
  4.6, 29
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  2250000, NULL,
  'Lawn', '2-Piece Suits', 'Women', 'Olive Green',
  NULL, 25,
  false,
  false,
  NULL,
  'Premium Collection', NULL, NULL, NULL, NULL,
  4.7, 25
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  3100000, NULL,
  'Net', '3-Piece Suits', 'Women', 'Ivory',
  NULL, 25,
  false,
  false,
  NULL,
  'Limited Edition', NULL, NULL, NULL, NULL,
  4.8, 12
)
on conflict (id) do update set
  title = excluded.title,
...
insert into products (
  ...
  850000, NULL,
  'Leather & Zardozi', 'Footwear', 'Women', 'Gold',
  NULL, 25,
  false,
  false,
  NULL,
...
insert into products (
  ...
  1420000, NULL,
  'Gold-Plated Metal & Pearl', 'Jewelry', 'Women', 'Gold',
  NULL, 25,
  false,
  false,
  NULL,
...
insert into products (
  ...
  2800000, NULL,
  'Pashmina Wool', 'Accessories', 'Women', 'Cream',
  NULL, 25,
  false,
  false,
  NULL,
